...
int KeyManage(int keycode, int mode) // 按键管理,mode=1renovate
{
    ...
    */
    ...
    // 同一按键时间
    if (SameKeyTime >= C_SAMEKEYTIME)
        mode1 = 1; // mode1 =1长按键0短按
    else
        mode1 = 0;
            ...
            if (MGetSystemMode() == 0 && mode1 == 1) /// 非测试模式下 长按输入数据
            {
                ...
                while (1) {
                    if (Input_Number(C_RANGE_HPOSI, C_RANGE_VPOSI, &number1, 4, &dec_len1, 0)) {
                        ...
                        if (((number1 < 90 || number1 > C_MAX_RANGE / 2) && MGetProbeMode() == 1) || ((number1 < 150 || number1 > C_MAX_RANGE) && MGetProbeMode() != 1)) {
                            DisplayPrompt(4);
                            MSetRange(range1, C_SETMODE_SETSAVE);
                        }

                        else if ((number1 >= 150 && number1 <= C_MAX_RANGE && MGetProbeMode() != 1) || (number1 >= 90 && number1 <= C_MAX_RANGE / 2 && MGetProbeMode() == 1)) {
                            MSetRange(number1, C_SETMODE_SETSAVE);
                            break;
                        }
                    ...
                    if (MGetStdMode() == 10) {
                        if (MGetThick() < 150) {
                            if (para4 >= -40)
                                ...
                                if (number <= MGetThick())
                                    TextOut(xpos + 6 * 24, ypos + 4 + 24, 1, 19, 24, (uint8_t *)szPingji[MGetLanguage()][2], 0); // TextOut(xpos+6*24,ypos+4+24,1,10,24,"超记录等级",0);
            ...
            case C_FUNC_GATEEXPEND: // 门内展宽
                ...
                if (MGetGatePara(0, 0) > 1) {
                    ...
                    while (true) {
                        ...
                        if (keycode == C_KEYCOD_GATE)
                            break;
                        else if (keycode == C_KEYCOD_RETURN || (funcNumber == 0 && keycode == C_FUNC_1) || (funcNumber == 1 && keycode == C_FUNC_2) || (funcNumber == 2 && keycode == C_FUNC_3) || (funcNumber == 3 && keycode == C_FUNC_4)) {
                            break;
                        }
                    }
                    g_UDiskInfo.DataHeaderMark = 1;
...
int ParaMenu1(int page) // 出现第几页的参数菜单
{
    ...
    while (1) {
        ...
        switch (page) {
            case 1:
                ...
                if (MGetTestStatus(C_TEST_AVG) == 1) {
                    ...
                    Write_Number(xpos, ypos, MGetLineGain(0), 5, 1, 1);
                ...
                if (MGetTestStatus(C_TEST_AVG) == 1) {
                    ...
                    Write_Number(xpos, ypos, MGetLineGain(1), 5, 1, 1);
                ...
                if (MGetTestStatus(C_TEST_AVG) == 1) {
                    ...
                    Write_Number(xpos, ypos, MGetLineGain(2), 5, 1, 1);
        ...
        do {
            ...
            keycode = MGetKeyCode(10);
            if ((keycode > 0 && keycode <= row_number) || (keycode == C_KEYCOD_PLUS || keycode == C_KEYCOD_MINUS) || (keycode == C_KEYCOD_LEFT || keycode == C_KEYCOD_RIGHT) || (keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN))
                break;
            else {
                keycode = MGetRotary(-1);
                if (keycode > 0)
        ...
        if (page == 1) {
            switch (keycode) {
                ...
                case 3: //
                    ...
                    while (true) // 如未设置连续存则不能输入
                    {
                        ...
                        if (Input_Number(xpos, ypos, &number, 4, &deci_len, 0) != 1)
                            ...
                            number /= 10;
                            if (MGetUnitType() > 0)
                                number = (UINT)(number * 254 / 1000.0 + 0.5); // 单位inch
                            k = c_DACLine[MGetStdMode()][MGetBlock()][C_STD_POS_THNUM];
                            for (i = 0; i < k; i++) {
                                if (MGetStdMode() == 0)
                                    break;
                                if (MGetStdMode() == 10 || MGetStdMode() == 11) {
                                    if (number >= c_DACLine[MGetStdMode()][MGetBlock()][C_STD_POS_THICK + 7 * i])
                                        continue;
                ...
                case 5: // 当量标准
                    ...
                    if (MGetCurveNumber() > 3)
                        ypos -= crow_height * (MGetCurveNumber() - 3);
...
#endif
                case 6: // Rl
                    if (MGetParaLock(1, C_LOCK_DACAVG) == 1)
                        break;
                    ...
                    while (1) {
                        if (Input_Number(xpos, ypos, &number, 3, &deci_len, sign) < 1)
                            break;
                        else {
                            if (MGetTestStatus(C_TEST_AVG) == 1) {
    ...
    while (1) {
        ...
        switch (page) {
            case 1:
                ...
                if ((MGetStdMode() == 10 || MGetStdMode() == 11 || MGetStdMode() == 14) && MGetTestStatus(C_TEST_DAC) == 1)
                    break; /// 11345退出
                if ((MGetStdMode() == 10 || MGetStdMode() == 11 || MGetStdMode() == 14) && MGetTestStatus(C_TEST_AVG) == 1)
                    break; /// 11345退出
        ...
        if (page == 1) {
            switch (keycode) {
                ...
                case 3: // 工件厚度
                    ...
                    {
                        if ((MGetBlock() == 0 && (MGetThick() < 60 || MGetThick() > 2000)) || (MGetBlock() == 1 && (MGetThick() < 80 || MGetThick() > 1200)) || (MGetBlock() == 2 && (MGetThick() <= 2000 || MGetThick() > 5000)) || (MGetBlock() == 3 && MGetThick() < 40))
                    ...
                    {
                        if ((MGetBlock() == 0 && (MGetThick() < 80 || MGetThick() > 1200)) || (MGetBlock() == 1 && (MGetThick() < 60 || MGetThick() > 1200)) || (MGetBlock() == 2 && (MGetThick() <= 1200 || MGetThick() > 4000)) || (MGetBlock() == 3 && MGetThick() < 40)) {
                            for (j = 0; j < MGetCurveNumber(); j++) {
                                MSetLineGain(j, 0);
                            }
                        }
                ...
                case 7: // Rl
                    ...
                    if (MGetTestStatus(C_TEST_AVG) == 1 && MGetUnitType() > 0)
                        deci_len = 3;
                    else
                        deci_len = 1;
                    number = 0;
                    ...
                    while (1) {
                        if (Input_Number(xpos, ypos - C_ECHAR_VDOT, &number, 3, &deci_len, sign) < 1)
                            break;
                        else {
                            if (MGetTestStatus(C_TEST_AVG) == 1) {
                                if (MGetUnitType() > 0) {
...
int ChannelMenu(void) {
    ...
    while (true) {
        ...
        do {
            ...
            keycode = MGetKeyCode(0);
            if ((keycode > 0 && keycode <= row_number) || (keycode == 0 && 10 == row_number) || ((keycode == C_KEYCOD_PLUS || keycode == C_KEYCOD_MINUS) && page_max > 1) || (keycode == C_KEYCOD_LEFT || keycode == C_KEYCOD_RIGHT) || (keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN) || (keycode == C_KEYCOD_DEL && extend == 0 || (keycode == 6) || (keycode == 7)))
                break;
            else {
                keycode = MGetRotary(-1);
                if (keycode > 0)
        ...
        if (page == 1) {
            switch (keycode) {
                case 2: /*探头类型 */
                    if (MGetParaLock(1, C_LOCK_PROBE) == 1)
                        break;
                    ...
                    while (1) {
                        ...
                        if (keycode == C_KEYCOD_RETURN || keycode == C_KEYCOD_CONFIRM)
                            ...
                            {
                                if (MGetUnitType() > 0)
                                    MSetSpeed(CD_SPEED_1 * 1000 / 254, C_SETMODE_SAVE); // 单位inch
                                else
                                    MSetSpeed(CD_SPEED_1, C_SETMODE_SAVE);
                            ...
                            {
                                if (MGetUnitType() > 0)
                                    MSetSpeed(CD_SPEED_3 * 1000 / 254, C_SETMODE_SAVE); // 单位inch
                                else
                                    MSetSpeed(CD_SPEED_3, C_SETMODE_SAVE);
                                if (UserInfo.pzPurchaser[0] == 0) {
                                    if (MGetProbeMode() == 0) {
                                        MSetFrequence(UserInfo.pzPurchaser[6], 0);
                                        MSetCrystal_l(UserInfo.pzPurchaser[7], 0 /*mode = 0*/);
                    ...
                    break;
                case 3: // 探头频率
                    if (MGetParaLock(1, C_LOCK_PROBE) == 1 || MGetParaLock(1, C_LOCK_DACAVG) == 1 || MGetParaLock(1, C_LOCK_DAC) == 1)
                        break;
                    deci_len = 2;
                    number   = 100;
                    while (1) {
                ...
                case 4: // 晶片尺寸
                    ...
                    int number1 = 100;
                    while (1) {
                        if (Input_Crystal(xpos, ypos, &number, &number1) != 1)
                            break;
                        else {
                    ...
                    break;
                case 5: // 折射角
                    if (MGetParaLock(1, C_LOCK_OFFSET) == 1 || MGetParaLock(1, C_LOCK_PROBE) == 1)
                        break;
                    number   = 0;
                    deci_len = 2;
                    if (Input_Number(xpos, ypos, &number, 2, &deci_len, 0) == 1) {
                ...
                case 6: // 声速
                    ...
                    break;
                case 7: // 前沿
                    if (MGetParaLock(1, C_LOCK_PROBE) == 1 || MGetParaLock(1, C_LOCK_OFFSET) == 1)
                        break;
                    if (MGetUnitType() > 0)
                        deci_len = 3; // 单位inch
                    else
            ...
            switch (keycode) {
                case 1: // 探头阻尼
                    if (MGetParaLock(1, C_LOCK_PROBE) == 1 || MGetParaLock(1, C_LOCK_DACAVG) == 1)
                        break;
                ...
                case 4: // 降噪
                    ...
                    while (1) {
                        ...
                        if (keycode == C_KEYCOD_RETURN || keycode == C_KEYCOD_CONFIRM)
                            ...
                            g_nDenoise = keycode;
                            if (g_nRepeat < 100 * g_nDenoise + 100)
                                g_nRepeat = 100 * g_nDenoise + 100;
                        ...
                        if (keycode == C_KEYCOD_RETURN || keycode == C_KEYCOD_CONFIRM)
                            ...
                            while (1) {
                                ...
                                do {
                                    ...
                                    keycode = MGetKeyCode(0);
                                    if ((keycode > 0 && keycode <= row_numbers) || (keycode == 0 && 10 == row_numbers) || ((keycode == C_KEYCOD_PLUS || keycode == C_KEYCOD_MINUS) && page_maxs > 1) || (keycode == C_KEYCOD_LEFT || keycode == C_KEYCOD_RIGHT) || (keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN) || (keycode == C_KEYCOD_DEL && extend == 0))
                                        break;
                                    else {
                                        keycode = MGetRotary(-1);
                                        if (keycode > 0)
                                ...
                                if (pages == 1) {
                                    switch (keycode) {
                                        ...
                                        case 4: // 斜探头默认频率
                                            deci_lens = 2;
                                            numbers   = 100;
                                            if (Input_Number(xpos + 70, ypos, &numbers, 2, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                        ...
                                        case 5: // 斜探头默认晶片尺寸
                                            numbers  = 100;
                                            number1s = 100;
                                            if (Input_Crystal(xpos + 120, ypos, &numbers, &number1s) != 1)
                                                break;
                                            else {
                                        ...
                                        case 8: // 双晶直探头默认频率
                                            deci_lens = 2;
                                            numbers   = 100;
                                            if (Input_Number(xpos + 120, ypos, &numbers, 2, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers > 0 && numbers <= 2000)
                                        ...
                                        case 9: // 双晶直探头默认晶片尺寸
                                            numbers  = 100;
                                            number1s = 100;
                                            if (Input_Crystal(xpos + 160, ypos, &numbers, &number1s) != 1)
                                                break;
                                            else {
                                                if (numbers <= 50000 && number1s <= 50000)
                                    ...
                                    switch (keycode) {
                                        ...
                                        case 3:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 180, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                        ...
                                        case 7:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 230, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                    ...
                                    switch (keycode) {
                                        case 1:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 130, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                        ...
                                        case 4:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 210, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                        ...
                                        case 6:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 250, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                    ...
                                    switch (keycode) {
                                        ...
                                        case 2:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 270, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                        ...
                                        case 7:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 300, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
                                        ...
                                        case 8:
                                            deci_lens = 1;
                                            numbers   = 0;
                                            if (Input_Number(xpos + 320, ypos, &numbers, 4, &deci_lens, 0) != 1)
                                                break;
                                            else {
                                                if (numbers <= 30000)
...
#endif
    {
        if (MGetFunctionMode(i) == 1)
            InvertWords(inv_xpos, inv_ypos + (i + 1) * crow_height - 2, 1); /*反白显示数字*/
    }
    DisplayPrompt(15);
    while (1) {
        MKeyRlx(); /*只有按键已释放才退出*/
        ...
        do {
            ...
            if (keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN)
                break;
            if (keycode >= 0 && keycode < row_number - 1)
                break;
        } while (1);
...
//		else if(keycode == C_FLAW_HEIGHT);//裂纹测高
            ...
            // 设置了门内展宽，则B门不能为进波
            if (MGetFunctionMode(C_CURVER_AMEND) == 1)
        ...
        switch (keycode) {
            ...
            case C_CURVER_AMEND:
                ...
                while (1) {
                    ...
                    while (true) {
                        keycode = MAnyKeyReturn();
                        if (keycode == 1 || keycode == 2 || keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN)
                            break;
                    }
...
int CustomizeColorMenu(void) {
    ...
    #if (C_COLOR == 1)
            if (i == row - 1)
                SetDisplayColor(RED_B0 | GREEN_B0 | BLUE_B0);
            else
                SetDisplayColor(c_crPara[i]);
    #endif
...
int STDMenu(void) // 标准菜单
{
    ...
    while (true) {
        ...
        do {
            ...
            keycode = MGetKeyCode(10);
            if (keycode >= 0 && keycode <= MGetCurveNumber() + 4)
                break;
        } while (keycode != C_KEYCOD_RETURN && keycode != C_KEYCOD_CONFIRM);
        ...
        switch (keycode) {
            case 0: // 标准
                ...
                while (1) {
                    ...
                    while (1) {
                        keycode = MAnyKeyReturn();
                        if ((keycode >= 1 && keycode <= 9 && pagemax1 == 0) || (keycode >= 1 && keycode <= 7 && pagemax1 == 1) || keycode == C_KEYCOD_PLUS || keycode == C_KEYCOD_MINUS || keycode == C_KEYCOD_CONFIRM || keycode == C_KEYCOD_RETURN)
                            break;
                    }
                    if (keycode == C_KEYCOD_PLUS) {
                        pagemax1++;
...
int TestFlawHigh(void) 
{
    ...
    for (keycode = 0; keycode < C_LEN_SAMP + 1; keycode++)
        sampbuff[keycode] = 0;
    num = 0;
    MSetDepth(0, 0);
    while (true) {
        ...
        while (true) {
            ...
            */
            if (keycode == C_KEYCOD_CONFIRM) {
                ...
                while (samp[left - 1] <= samp[left] && samp[left] > 0)
                    left--;
                while (samp[right] >= samp[right + 1] && samp[right] > 0)
                    right++;
            ...
            // else if( num == 0 && (keycode == C_KEYCOD_RANGE || keycode == C_KEYCOD_BASEGAIN) )
                ...
                if (keycode == C_FUNC_1)
                    i = 0;
                else if (keycode == C_FUNC_2)
                    i = 1;
                else if (keycode == C_FUNC_3)
                    i = 2;
                else if (keycode == C_FUNC_4)
                    i = 3;
        ...
        if (num == 2) {
            ...
            if (MGetUnitType() > 0)
                EMenuOut(menu_xpos + 16 + (len - 1) * C_CCHAR_HDOT, menu_ypos + 4, "in", 2, 1, 8);
            else
                EMenuOut(menu_xpos + 16 + (len - 1 + 3 * MGetLanguage()) * C_CCHAR_HDOT, menu_ypos + 4, "mm", 2, 1, 8);
...
#endif
                    if (y0 != ypos)
                        MDrawLine(x0, y0, x0, ypos, C_CR_WAVEBACK);
                    y0   = ypos;
                    flag = 1;
